...
import { ApiListResponse, Material } from './auth';
...
export class MaterialService {
  ...
  getMaterials(): Observable<ApiListResponse<Material>> {
    return this.http.get<ApiListResponse<Material>>(this.apiUrl); // Aucun token requis
  }
